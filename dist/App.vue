        ...
        <div v-if="answers.length == 0 && online == true">
            <h1 class="title mdc-typography--headline">
                ...
                <br>
                    ...
                    <p class="mdc-typography--body2">You can type "when is the libary open" for example. Or just press on the microphone to talk</p>
            </h1>
        </div>
        ...
        <div v-if="answers.length == 0 && online == false">
            <h1 class="title mdc-typography--headline">
                ...
                <br>
                    ...
                    <p class="mdc-typography--body2">Hey, looks like you're not connected to the internet, I  <b>require</b> internet connection, to process your requests</p>
            </h1>
        </div>
...
// b2abd59659884979bc59902dc83861ba
